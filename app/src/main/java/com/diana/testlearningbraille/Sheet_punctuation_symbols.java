...
public class Sheet_punctuation_symbols extends AppCompatActivity {
    ...
    public void Sound( int code) {
        ...
        switch (code) {
            case 1:
                MediaPlayer mp1;
                mp1 = MediaPlayer.create(this, R.raw.nn_sonido_morse);
                mp1.start();
                break;

            case 2:
                MediaPlayer mp2;
                mp2 = MediaPlayer.create(this, R.raw.w_himno_usa);
                mp2.start();
                break;

            case 3:
                MediaPlayer mp3;
                mp3 = MediaPlayer.create(this, R.raw.u_dieresis);
                mp3.start();
                break;

            case 4:
                MediaPlayer mp4;
                mp4 = MediaPlayer.create(this, R.raw.p_punto);
                mp4.start();
                break;

            case 5:
                MediaPlayer mp5;
                mp5 = MediaPlayer.create(this, R.raw.c_coma);
                mp5.start();
                break;

            case 11:
                MediaPlayer mp6;
                mp6 = MediaPlayer.create(this, R.raw.alphabet_nn);
                mp6.start();
                break;

            case 12:
                MediaPlayer mp7;
                mp7 = MediaPlayer.create(this, R.raw.alphabet_w);
                mp7.start();
                break;

            case 13:
                MediaPlayer mp8;
                mp8 = MediaPlayer.create(this, R.raw.alphabet_u_dieresis);
                mp8.start();
                break;

            case 14:
                MediaPlayer mp9;
                mp9 = MediaPlayer.create(this, R.raw.alphabet_punto);
                mp9.start();
                break;

            case 15:
                MediaPlayer mp10;
                mp10 = MediaPlayer.create(this, R.raw.alphabet_coma);
                mp10.start();
                break;
            ...
            case 23:
                MediaPlayer mp14;
                mp14 = MediaPlayer.create(this, R.raw.sheet_punctuation_symbols_);
                mp14.start();
                break;
            case 24:
                MediaPlayer mp15;
            ...
            case 40:
                MediaPlayer mp28;
                mp28 = MediaPlayer.create(this, R.raw.numbers_nn);
                mp28.start();
                break;
            case 41:
                MediaPlayer mp29;
                mp29 = MediaPlayer.create(this, R.raw.numbers_w);
                mp29.start();
                break;
            case 42:
                MediaPlayer mp30;
                mp30 = MediaPlayer.create(this, R.raw.numbers_u_umlaut);
                mp30.start();
                break;
            case 43:
                MediaPlayer mp31;
                mp31 = MediaPlayer.create(this, R.raw.numbers_dot);
                mp31.start();
                break;
            case 44:
                MediaPlayer mp32;
                mp32 = MediaPlayer.create(this, R.raw.numbers_comma);
                mp32.start();
                break;
