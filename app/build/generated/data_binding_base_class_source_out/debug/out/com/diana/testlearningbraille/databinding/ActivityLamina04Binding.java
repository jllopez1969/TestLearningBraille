...
public final class ActivityLamina04Binding implements ViewBinding {
  @NonNull
  ...
  private ActivityLamina04Binding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ActivityLamina04Binding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityLamina04Binding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_lamina04, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityLamina04Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLamina04Binding((ConstraintLayout) rootView, IniciarTest,
